...
macro(cmakejson_variable_exists_or_error)
...
function(cmakejson_set_directory_property)
    ...
    cmakejson_variable_exists_or_error(PREFIX "${_VAR_PREFIX}" VARIABLE_NAMES "PROPERTY;VARIABLE")
    if(${_VAR_PREFIX}_PREFIX)
        set_property(DIRECTORY ${${_VAR_PREFIX}_APPEND_OPTION} PROPERTY _CMakeJSON_${${_VAR_PREFIX}_PROPERTY} ${${${_VAR_PREFIX}_PREFIX}_${${_VAR_PREFIX}_PROPERTY}} ${${_VAR_PREFIX}_UNPARSED_ARGUMENTS})
    else()
        set_property(DIRECTORY ${${_VAR_PREFIX}_APPEND_OPTION} PROPERTY _CMakeJSON_${${_VAR_PREFIX}_PROPERTY} ${${${_VAR_PREFIX}_PROPERTY}} ${${_VAR_PREFIX}_UNPARSED_ARGUMENTS})
    endif()
endfunction()
